...
namespace Biblioteca_de_clases
{
    ...
    public abstract class Inmueble
    {
        ...
        public Inmueble(string _nombreI, string _direccionI, int _superficieI, estado _estadoI, float _precioI, Contacto _contacto1)
        {
        ...
        public float PrecioI { get => precioI; set => precioI = value; }
        ...
        public float calcularPrecio(float preciox)
        {
